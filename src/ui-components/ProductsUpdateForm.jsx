...
export default function ProductsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setUnit_price(cleanValues.unit_price);
    setMarkup_percentage(cleanValues.markup_percentage);
    setSale_price(cleanValues.sale_price);
    setIs_deleted(cleanValues.is_deleted);
    setType(cleanValues.type);
    setProduct_images(cleanValues.product_images ?? []);
