...
export default function WarehouseUpdateForm(props) {
  const {
    id: idProp,
    warehouse: warehouseModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [warehouseRecord, setWarehouseRecord] =
    React.useState(warehouseModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getWarehouse.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getWarehouse
        : warehouseModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateWarehouse.replaceAll("__typename", ""),
            variables: {
              input: {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || warehouseModelProp)}
